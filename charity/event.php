...
<?php while($row = mysqli_fetch_assoc($select_data_event)) { ?>
                    <div class="col-lg-6">
                        <div class="event-item">
                            <img src="img/<?= $row['img_event']?>" alt="Image">
...
<form action="" method="POST">
                                    <?php $usr_event = mysqli_fetch_assoc($select_user_event);
                                    if(isset($usr_event['id_event'])){ ?>
                                        <input type="submit" class="btn btn-custom" value="Already Join" disabled name="submit">
                                   <?php }else{
                                    if($row['status'] == "available") {  ?>
                                    
                                    <a href="update_event.php?id=<?=$row['id_event'] ?>" class="btn btn-custom">Join Now</a>
                                        <!-- <input type="submit" class="btn btn-custom" value="Join Now" name="submit"> -->
                                    <!-- <a class="btn btn-custom" href="">Join Now</a> -->
                                <?php }else{?>
                                    <input type="submit" class="btn btn-custom" value="Full" name="submit" disabled >
                                    <?php }} ?>
                                    </form>
                                </div>
                            </div>
