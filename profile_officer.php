...
$select_data_event = mysqli_query($connect,"SELECT * FROM officer");
$i =1;
        ...
        <div class="Box-menu">
            <ul class="ul-menu">
                ...
                <li class="li-mneu Active-menu">
                    ...
                    <div class="title-menu"><a href="admin_page.php">Profile Officer</a> </div>
                </li>
                <li class="li-mneu">
        ...
        <div class="Box-elements">
            ...
            <div class="box-element-flex">
                <div class="transction" style="top:-5px;">
                    <div class="title-element">Profile Officer </div>
                    <?php 
                    // $select_user = mysqli_query($connect,"SELECT * FROM user_form LIMIT 7") ;
                    while($row = mysqli_fetch_assoc($select_data_event)){?>
